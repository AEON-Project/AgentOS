...
if (major < 25) {
  console.error(`agentos requires Node.js >= 25. Current: v${process.versions.node}`);
...
program
  .name("agentos")
  .description("AEON AgentOS CLI — platform-level execution system for AI Agents. Current skill: AI image generation via x402 protocol, paid with USDT on BSC.")
